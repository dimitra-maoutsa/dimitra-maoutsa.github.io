...
- **Neuromatch Academy Computational Neuroscience summer school project mentor**: Mentored two groups on their research projects on **a PFC-Motor RNN** project (group Manifold Mechanics) and on **inter-area communications** using the IBL dataset (group 404). \
 **[completed: July 2025]**


- **Neuromatch Academy NeuroAI summer school project mentor**: Mentored four groups on their research projects. Two groups working on **biologically informed network architectures** for robotic control, and two on **biologically plausible learning algorithms**. \
 **[completed: July 2025]**
