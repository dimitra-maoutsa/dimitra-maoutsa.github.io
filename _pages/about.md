...
I am broadly interested in **how learning and synaptic plasticity shape collective population dynamics and representational geometries, and how these changes manifest in behaviour.** For more specific current directions, feel free to reach out. Briefly current project involve devising a reinforcement learning based method for discovering plasticity rules for reinforcement training of RNNs [see more](https://dimitra-maoutsa.github.io/portfolio/portfolio--1/) and modelling contextual reconfiguration of representations through top-down feedback [see more](https://dimitra-maoutsa.github.io/portfolio/portfolio-0b/). For further (not presented) directions, please feel free to reach out to me.
