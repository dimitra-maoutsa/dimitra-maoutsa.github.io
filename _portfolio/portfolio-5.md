...
The central premise is that geodesics computed on the empirical manifold consitute the most probable path between consecutive observations in the Onsager-Machlup sense.
